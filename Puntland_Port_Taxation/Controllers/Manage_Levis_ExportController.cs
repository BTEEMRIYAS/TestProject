...
{
    public class Manage_Levis_ExportController : Controller
    {
        private Puntland_Port_Taxation_DBEntities db = new Puntland_Port_Taxation_DBEntities();

        //
        // GET: /Manage_Levis_Export/
        ...
        public ActionResult Index(int levi_entry_id = 0)
        {
            if (Session["login_status"] != null)
            {
                ...
                if (z.Contains(36))
                {
                    ...
                    if (levi_entry_id == 0)
                    {
                        count = db.E_Levi_Entry.Where(l => l.end_date == end_date).Count();
                    }
                    else
                    {
                        count = 1;
                    ...
                    if (levi_entry_id == 0)
                    {
                        var levi_entry_display = (db.E_Display_Levi_Entries_View(null)).OrderBy(l => l.Levi_entry_id).Skip(start_from).Take(9).ToList();
                        return View(levi_entry_display);
                    }
                    else
                    {
                        var levi_entry_display = db.E_Display_Levi_Entries_View(levi_entry_id).ToList();
                        return View(levi_entry_display);
                    }
                }
                else
        ...
        //
        // GET: /Manage_Levis_Export/Details/5
        ...
        public ActionResult Details(int id = 0)
        {
            if (Session["login_status"] != null)
            {
                ...
                if (z.Contains(36))
                {
                    var levi_entry_display = db.E_Display_Levi_Entries_View(id).ToList();
                    return View(levi_entry_display);
                }
                else
                {
        ...
        //
        // GET: /Manage_Levis_Export/Create
        ...
        //
        // POST: /Manage_Levis_Export/Create
        ...
        public ActionResult Create(Levi_EntryModel levi_entryModel)
        {
            if (Session["login_status"] != null)
            {
                ...
                if (z.Contains(36))
                {
                    ...
                    E_Levi_Entry levi_entry = new E_Levi_Entry();
                    if (ModelState.IsValid)
                    {
                        var is_exist = (from le in db.E_Levi_Entry where le.levi_name == levi_entryModel.levi_name && le.end_date == end_date select le).Count();
                        if (is_exist > 0)
                        {
                        ...
                        else
                        {
                            ...
                            db.E_Levi_Entry.Add(levi_entry);
                            db.SaveChanges();
                            db.Update_Levi();
        ...
        //
        // GET: /Manage_Levis_Export/Edit/5
        ...
        public ActionResult Edit(int id = 0)
        {
            if (Session["login_status"] != null)
            {
                ...
                if (z.Contains(36))
                {
                    ...
                    var goods_id = 0;
                    var goods_name = "";
                    E_Levi_Entry levi_entry = db.E_Levi_Entry.Find(id);
        ...
        //
        // POST: /Manage_Levis_Export/Edit/5
        ...
        public ActionResult Edit(Levi_EntryModel levi_entryModel)
        {
            if (Session["login_status"] != null)
            {
                ...
                if (z.Contains(36))
                {
                    ...
                    var end_date = "9999-12-31";
                    E_Levi_Entry levi_entry = db.E_Levi_Entry.Find(levi_entry_id);
                    ...
                    if (ModelState.IsValid)
                    {
                        var is_exist = (from le in db.E_Levi_Entry where le.levi_name == levi_entryModel.levi_name && le.Levi_entry_id != levi_entry_id && le.end_date == end_date select le).Count();
                        if (is_exist > 0)
                        {
                            TempData["errorMessage"] = "This Levy Name Already Exist";
                        }
        ...
        //
        // GET: /Manage_Levis_Export/Delete/5
        ...
        //
        // POST: /Manage_Levis_Export/Delete/5
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            if (Session["login_status"] != null)
            {
                ...
                {
                    E_Levi_Entry levi_entry = db.E_Levi_Entry.Find(id);
                    db.E_Levi_Entry.Remove(levi_entry);
                    db.SaveChanges();
                    return RedirectToAction("Index");
                }
                else
        ...
        //
        // GET: /Manage_Levis_Export/DbSearch
        ...
        //
        // POST: /Manage_Levis_Export/DbSearchresult
        //In this function is for database search
        [HttpPost]
        public ActionResult DbSearchresult(E_Levi_Entry levi_entry)
        {
            if (Session["login_status"] != null)
            {
                int[] z = (int[])Session["function_id"];
                if (z.Contains(36))
                {
                    ...
                    {
                        var result = from l in db.E_Levi_Entry
