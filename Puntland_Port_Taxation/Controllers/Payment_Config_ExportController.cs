...
{
    public class Payment_Config_ExportController : Controller
    {
        private Puntland_Port_Taxation_DBEntities db = new Puntland_Port_Taxation_DBEntities();

        //
        // GET: /Payment_Config_Export/
        ...
        public ActionResult Index()
        {
            if (Session["login_status"] != null)
            {
                ...
                if (z.Contains(25))
                {
                    ...
                    return View(db.E_Payment_Config.Where(p => p.end_date == end_date).ToList());
                }
                else
                {
        ...
        {
            E_Payment_Config payment_config = db.E_Payment_Config.Find(id);
        ...
        {
            E_Payment_Config payment_config = db.E_Payment_Config.Find(id);
            db.E_Payment_Config.Remove(payment_config);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
